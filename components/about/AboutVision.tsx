      ...
      <div className="grid md:grid-cols-2 grid-cols-1 gap-8">
        ...
        <div className="flex flex-col my-auto">
          ...
          <p className="regular-16-w">
            ...
            innovating, expanding our offerings, and exploring new frontiers in
            the world of premium spirits. Join us as we embark on this exciting
            adventure, where every sip is a celebration of craftsmanship, and
            every bottle is a testament to our unwavering pursuit of excellence.
          </p>
        </div>
      </div>
    </section>
