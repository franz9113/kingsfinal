...
const HomeNewsletter = () => {
  return (
    ...
    <div className="min-h-96 bg-black opacity-60 padding-component flex items-center">
      <div className="grid md:grid-cols-2 grid-cols-1 gap-8 w-full justify-center">
