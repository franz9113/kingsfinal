...
const BencockyVersatile = () => {
  return (
    <section className="bg-[#FFD252] padding-component">
      <div className="grid lg:grid-cols-3 grid-cols-1 gap-8 mb-20">
        {/* 1st */}
        <div className="">
      ...
      <div className="grid md:grid-cols-2 grid-cols-1 gap-8">
        <div className="md:order-1 order-2 flex flex-col md:text-right m-auto">
          ...
          <p>
            ...
            transported to our cellars in Cognac. The batches are then assembled
            and reduced with pure water from Charentes. It can be enjoyed with
            cola, in tonic, or in a cocktail for a fresh and balanced long
            drink.
          </p>
        </div>
